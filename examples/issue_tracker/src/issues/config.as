...
private Result<nuint, string> ParseLimit(string value) {
    ...
    for (nuint index = 0; index < length; index++) {
        ...
        result = result * 10 + (nuint)(byte - 48);
    }
