...
|---|---:|---:|
| create 1,000 keyed rows | 11.0 ms | **9.3 ms** |
| update every tenth row | **2.4 ms** | 4.6 ms |
| swap two rows | **0.3 ms** | 2.6 ms |
| append 1,000 keyed rows | 12.8 ms | **8.2 ms** |
| delete one middle row | **0.5 ms** | 4.4 ms |
| clear 1,999 rows | **4.6 ms** | 7.2 ms |
| client code, raw | **41.7 KB** | 111.9 KB |
| client code, gzip | **10.8 KB** | 41.9 KB |
