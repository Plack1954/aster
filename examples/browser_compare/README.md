...
|---|---:|---:|
| create 1,000 keyed rows | 12.0 ms | **11.5 ms** |
| update every tenth row | **2.4 ms** | 4.4 ms |
| swap two rows | **0.4 ms** | 3.4 ms |
| append 1,000 keyed rows | 13.8 ms | **8.8 ms** |
| delete one middle row | **0.4 ms** | 4.2 ms |
| clear 1,999 rows | **4.6 ms** | 7.3 ms |
| client code, raw | **52.0 KB** | 111.9 KB |
| client code, gzip | **12.5 KB** | 41.9 KB |
