...
|---|---:|---:|
| create 1,000 keyed rows | 13.1 ms | **9.2 ms** |
| update every tenth row | **2.7 ms** | 3.0 ms |
| swap two rows | **0.2 ms** | 2.7 ms |
| append 1,000 keyed rows | 12.7 ms | **9.2 ms** |
| delete one middle row | **0.5 ms** | 4.4 ms |
| clear 1,999 rows | **4.9 ms** | 7.1 ms |
| client code, raw | **58.8 KB** | 111.9 KB |
| client code, gzip | **13.8 KB** | 41.9 KB |
