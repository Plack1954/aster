...
|---|---:|---:|
| create 1,000 keyed rows | 12.3 ms | **10.4 ms** |
| update every tenth row | **3.0 ms** | 5.2 ms |
| swap two rows | **0.6 ms** | 2.5 ms |
| append 1,000 keyed rows | 14.9 ms | **8.6 ms** |
| delete one middle row | **0.5 ms** | 4.3 ms |
| clear 1,999 rows | **4.9 ms** | 7.2 ms |
| client code, raw | **44.1 KB** | 111.9 KB |
