...
grep -q 'data-aster-project="t:summary"' <<<"$page"
grep -q 'data-aster-project="d:disabled"' <<<"$page"
grep -q 'data-aster-project="c:className"' <<<"$page"
grep -q 'data-aster-event="click|SelectSecondAndRemoveFirst|p|l:selectedId"' <<<"$page"
grep -q 'data-aster-project="c:secondClass"' <<<"$page"
