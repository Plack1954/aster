...
site_directory=$(mktemp -d "$scratch_root/lime-ssg.XXXXXX")
cleanup() {
...
"$lang" project build-site \
    packages/lime/aster.toml "$site_directory" ssg_smoke
...
cmp packages/lime/test_assets/site.css "$site_directory/assets/site.css"
