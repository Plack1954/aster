if(NOT DEFINED LANG_EXECUTABLE OR NOT DEFINED C_COMPILER OR
   NOT DEFINED PROJECT_FILE OR
   NOT DEFINED OUTPUT_DIRECTORY)
    message(FATAL_ERROR
        "LANG_EXECUTABLE, C_COMPILER, PROJECT_FILE, and OUTPUT_DIRECTORY are required")
endif()
...
string(SHA256 PROJECT_ID "${PROJECT_FILE}")
string(SUBSTRING "${PROJECT_ID}" 0 12 PROJECT_ID)
set(GENERATED_C
    "${OUTPUT_DIRECTORY}/aster_project_${PROJECT_NAME}_${PROJECT_ID}.c")
set(GENERATED_EXE
    "${OUTPUT_DIRECTORY}/aster_project_${PROJECT_NAME}_${PROJECT_ID}${EXECUTABLE_SUFFIX}")
...
if(DEFINED CRYPTO_LIBRARY)
    list(APPEND LINK_INPUTS "${CRYPTO_LIBRARY}")
endif()
if(DEFINED OPENSSL_CRYPTO_LINK_LIBRARY)
    list(APPEND LINK_INPUTS "${OPENSSL_CRYPTO_LINK_LIBRARY}")
endif()
