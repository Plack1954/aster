...
const char *lang_token_name(TokenKind kind) {
    static const char *names[] = {
        ...
        "var","new","delete","const","ref","out","struct","class","interface","enum","union","if","else","while","for","foreach","in","switch","case",
        "return","break","continue","true","false","null","unsafe","try","catch","finally","throw","async","await",
        "namespace","using","as","public","private","static",
        "abstract","virtual","override","sealed","readonly","extern",
        "type","delegate","element",
        "(",")","{","}","[","]",",",":",
        ";",".","..","..=","+","-","*","/","%","++","--","+=","-=","*=","/=","%=",
        "&","|","^","~","&=","|=","^=","<<=",">>=",
        "&&","||",
