...
typedef enum IrOpcode {
    ...
    IR_OP_ENUM_IS,
    IR_OP_ENUM_PAYLOAD_BORROW,
    IR_OP_COLLECTION_COUNT,
    IR_OP_LIST_ELEMENT_BORROW,
    IR_OP_QUEUE_FRONT_BORROW,
    IR_OP_STACK_TOP_BORROW,
    IR_OP_DICTIONARY_GET_BORROW,
    IR_OP_DICTIONARY_FIND,
...
typedef enum OpCode {
    ...
    OP_LOAD_LOCAL, OP_STORE_LOCAL, OP_MOVE_LOCAL, OP_DEFAULT_LOCAL,
    OP_REFERENCE_LOCAL,
    ...
    OP_SET_FIELD_LOCAL, OP_DEFAULT_FIELD_LOCAL,
    OP_GET_TAG, OP_TAKE_PAYLOAD, OP_BORROW_PAYLOAD,
    OP_COLLECTION_COUNT, OP_LIST_ELEMENT_BORROW,
    OP_QUEUE_FRONT_BORROW, OP_STACK_TOP_BORROW,
    OP_DICTIONARY_GET_BORROW, OP_DICTIONARY_FIND,
    OP_DICTIONARY_KEY_BORROW,
    OP_DICTIONARY_VALUE_BORROW, OP_SET_LOCAL,
