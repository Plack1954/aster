...
static const char *op_name(OpCode op) {
    static const char *names[] = {
        ...
        "MOVE_LOCAL","DEFAULT_LOCAL","REFERENCE_LOCAL","REFERENCE_FIELD_LOCAL","INVALIDATE_LOCAL",
        ...
        "GET_INDEX_LOCAL","GET_INDEX_LOCAL_MOVE","SET_INDEX_LOCAL",
        "MAKE_STRUCT","MAKE_CLASS",
        "DELETE_CLASS","GET_FIELD",
        "GET_FIELD_LOCAL","GET_FIELD_LOCAL_MOVE",
        "GET_FIELD_BORROW","SET_FIELD_LOCAL","DEFAULT_FIELD_LOCAL",
        "GET_TAG","TAKE_PAYLOAD","BORROW_PAYLOAD","COLLECTION_COUNT",
        "LIST_ELEMENT_BORROW",
        "QUEUE_FRONT_BORROW","STACK_TOP_BORROW",
        "DICTIONARY_GET_BORROW","DICTIONARY_FIND",
        "DICTIONARY_KEY_BORROW","DICTIONARY_VALUE_BORROW","SET_LOCAL",
