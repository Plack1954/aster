...
private Response EmptyResponseWithLocation(int status, string location)
{
    ...
    response.AddHeader(AsterWebResultOrThrow(
...
private T AsterWebResultOrThrow<T>(Result<T, string> result)
{
    switch (result)
    {
...
private Response WithAllowedMethods(Response response, List<string> methods)
{
    ...
    ResponseHeader allow = AsterWebResultOrThrow(
